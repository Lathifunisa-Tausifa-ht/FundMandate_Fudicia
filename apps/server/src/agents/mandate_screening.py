        ...
        for msg in messages:
            if isinstance(msg, HumanMessage):
                try:
                    ...
                    print("Exception in getting the input values" , e)
...
- Only include companies with status "Pass" or "Conditional"
- Do not include companies that failed screening or any other status
- Only output companies that were returned by the tools"""
    ...
    try:
        ...
        print("[AGENT] Getting thinking/analysis and tool calls from LLM...")
        ...
        if hasattr(tool_response, 'tool_calls') and tool_response.tool_calls:
            ...
            print("[AGENT] No tool calls found - analysis only")
